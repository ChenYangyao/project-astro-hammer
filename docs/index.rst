.. AstroHammer documentation master file, created by
   sphinx-quickstart on Tue Jun 22 05:34:34 2021.
...
.. |badge1| image:: https://readthedocs.org/projects/project-astro-hammer/badge/?version=latest
   :target: https://hipp.readthedocs.io/en/latest/?badge=latest
   :alt: Documentation Status

.. |badge2| image:: https://img.shields.io/github/last-commit/ChenYangyao/project-astro-hammer
   :target: https://github.com/ChenYangyao/project-astro-hammer/commits/master
   :alt: Commits 

.. |badge3| image:: https://img.shields.io/github/license/ChenYangyao/project-astro-hammer
   :target: https://github.com/ChenYangyao/project-astro-hammer/blob/master/LICENSE
   :alt: License
...
- This `Github <https://github.com/ChenYangyao/project-astro-hammer>`_ repository: all material (code samples, data samples, 
  lecture videos, problem sets and solutions) are hosted here.
- The lecture notes are served in `Read the Docs <https://project-astro-hammer.readthedocs.io/>`_.
...
The project, currently, is organized by Kai Wang (`kosmoswalker.com <https://www.kosmoswalker.com/>`_) 
and Yangyao Chen (`chenyangyao.com <https://www.chenyangyao.com/>`_). We welcome everyone 
...
The current prepared topics are listed below. We prepare to finish them in 
(at-least) 7 meetings.
...
.. toctree::
   ...
   usage/python-programming/index
   usage/cpp-programming/index
   usage/algorithms/index
